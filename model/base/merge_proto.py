...
class merge(nn.Module):
    ...
    def forward(self, qur_sups, sims,diffs,gt=None,name=''):
        qs_sim = []
        ...
        x4 = self.conv4(self.sqShotConv4(qs_lySim[0]/self.shot))

        x3 = self.conv3(self.sqShotConv3(qs_lySim[1]/self.shot))

        x2 = self.conv2(self.sqShotConv2(qs_lySim[2]/self.shot))
